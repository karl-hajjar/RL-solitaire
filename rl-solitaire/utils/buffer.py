...
class Buffer(object):
    ...
    and then sample batches to update the network. Each data point in the buffer is represented as a dictionnary, where each key repre-
...
# 	'''
# 	Returns a batch as a dictionary where each attribute data is represented as a batch
# 	'''
# 	shuffled = self.buffer.copy()
# 	shuffle(shuffled)
